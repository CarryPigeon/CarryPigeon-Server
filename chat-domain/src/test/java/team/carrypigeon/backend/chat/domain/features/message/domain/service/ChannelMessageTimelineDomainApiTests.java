...
class ChannelMessageTimelineDomainApiTests {
    ...
    void searchChannelMessages_validQuery_returnsMatchingMessages() {
        ...
        fixture.messageRepository.searchResults.add(new ChannelMessage(
                5003L, MessageDomainApiTestSupport.SERVER_ID, 1L, 1L, 1002L, "text",
                "hello body", "[文本消息] hello body", "hello body", null, null, "sent", MessageDomainApiTestSupport.BASE_TIME.plusSeconds(2)
        ));

        ChannelMessageSearchResult result = fixture.timelineApi.searchChannelMessages(
    ...
    void getChannelMessageHistory_member_returnsMessagesAndNextCursor() {
        ...
        fixture.messageRepository.history.add(new ChannelMessage(
                5002L, MessageDomainApiTestSupport.SERVER_ID, 1L, 1L, 1002L, "text", "second", "[文本消息] second", "second", null, null, "sent", MessageDomainApiTestSupport.BASE_TIME.plusSeconds(1)
        ));
        fixture.messageRepository.history.add(new ChannelMessage(
                5001L, MessageDomainApiTestSupport.SERVER_ID, 1L, 1L, 1001L, "text", "first", "[文本消息] first", "first", null, null, "sent", MessageDomainApiTestSupport.BASE_TIME
        ));

        ChannelMessageHistoryResult result = fixture.timelineApi.getChannelMessageHistory(
    ...
    void getChannelMessageHistory_recalledMessage_keepsStableIdentityWithRedactedContent() {
        MessageDomainApiTestSupport.Fixture fixture = new MessageDomainApiTestSupport.Fixture(null);
        fixture.messageRepository.history.add(new ChannelMessage(
                5008L, MessageDomainApiTestSupport.SERVER_ID, 1L, 1L, 1002L, "text", "[消息已撤回]", "[消息已撤回]", null, null, null, "recalled",
    ...
    void getChannelMessageHistory_extensionMessage_keepsPayloadAndMetadata() {
        MessageDomainApiTestSupport.Fixture fixture = new MessageDomainApiTestSupport.Fixture(null);
        fixture.messageRepository.history.add(new ChannelMessage(
                5009L, MessageDomainApiTestSupport.SERVER_ID, 1L, 1L, 1002L, "test-extension", "mc bridge", "[插件消息] mc bridge", "mc bridge test-extension",
    ...
    void searchChannelMessages_customMessage_keepsPreviewText() {
        MessageDomainApiTestSupport.Fixture fixture = new MessageDomainApiTestSupport.Fixture(null);
        fixture.messageRepository.searchResults.add(new ChannelMessage(
                5010L, MessageDomainApiTestSupport.SERVER_ID, 1L, 1L, 1002L, "custom",
                "status card", "[自定义消息] status card", "status card",
                "{\"card\":\"server-status\"}", null, "sent", MessageDomainApiTestSupport.BASE_TIME.plusSeconds(3)
        ));
    ...
    void getChannelMessageHistory_systemMessage_keepsPreviewText() {
        ...
        fixture.messageRepository.history.add(new ChannelMessage(
                5011L, MessageDomainApiTestSupport.SERVER_ID, 2L, 2L, 1001L, "system",
                "maintenance notice", "[系统消息] maintenance notice", "maintenance notice",
                "{\"severity\":\"info\"}", null, "sent", MessageDomainApiTestSupport.BASE_TIME.plusSeconds(4)
        ));
    ...
    void getChannelMessageHistory_missingChannel_throwsNotFoundProblem() {
        ...
        ProblemException exception = assertThrows(
                ...
                () -> fixture.timelineApi.getChannelMessageHistory(new GetChannelMessageHistoryQuery(1001L, 9L, null, null, null, null, 20))
        );
    ...
    /**
     * 验证 `getChannelMessageHistory` 在 `aroundMid` 条件下满足 `returnsContextualMessages` 的测试契约。
     */
    @Test
    ...
    void getChannelMessageHistory_aroundMid_returnsContextualMessages() {
        MessageDomainApiTestSupport.Fixture fixture = new MessageDomainApiTestSupport.Fixture(null);
        fixture.messageRepository.history.add(new ChannelMessage(
                5003L, MessageDomainApiTestSupport.SERVER_ID, 1L, 1L, 1002L, "text", "third", "[文本消息] third", "third", null, null, "sent", MessageDomainApiTestSupport.BASE_TIME.plusSeconds(2)
        ));
        fixture.messageRepository.history.add(new ChannelMessage(
                5002L, MessageDomainApiTestSupport.SERVER_ID, 1L, 1L, 1002L, "text", "second", "[文本消息] second", "second", null, null, "sent", MessageDomainApiTestSupport.BASE_TIME.plusSeconds(1)
        ));
    ...
    /**
     * 验证 `searchChannelMessages` 在 `advancedFilters` 条件下满足 `narrowResults` 的测试契约。
     */
    @Test
    ...
    void searchChannelMessages_advancedFilters_narrowResults() {
        MessageDomainApiTestSupport.Fixture fixture = new MessageDomainApiTestSupport.Fixture(null);
        fixture.messageRepository.searchResults.add(new ChannelMessage(
                5004L, MessageDomainApiTestSupport.SERVER_ID, 1L, 1L, 1002L, "text", "hello alpha", "[文本消息] hello alpha", "hello alpha", null, null, "sent", MessageDomainApiTestSupport.BASE_TIME.plusSeconds(3)
        ));
        fixture.messageRepository.searchResults.add(new ChannelMessage(
                5003L, MessageDomainApiTestSupport.SERVER_ID, 1L, 1L, 1003L, "text", "hello beta", "[文本消息] hello beta", "hello beta", null, null, "sent", MessageDomainApiTestSupport.BASE_TIME.plusSeconds(2)
        ));
