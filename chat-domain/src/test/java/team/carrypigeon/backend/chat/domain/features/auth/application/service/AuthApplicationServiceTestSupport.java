...
final class AuthApplicationServiceTestSupport {
    ...
    static AuthApplicationService createService(
    ...
    static final class Fixture {
        ...
        final AuthApplicationService service = createService(
                accountRepository,
                refreshSessionRepository,
                userProfileRepository,
                channelRepository,
