...
import team.carrypigeon.backend.chat.domain.features.channel.application.service.ChannelApplicationServiceTestSupport.RollbackingTransactionRunner;
 ...
 */
@Tag("contract")
class ChannelApplicationServiceApplicationFlowTests {
    ...
    void inviteChannelMember_ownerInvite_createsPendingInvite() {
        ...
        ChannelApplicationFlowApplicationService service = context.createApplicationFlowService();
    ...
    void createChannelApplication_rollback_skipsRealtimePublish() {
        TestContext context = newContext();
        context.channelRepository.channels.put(9L, privateChannel(9L, "project-alpha"));
        ChannelApplicationFlowApplicationService service = context.createApplicationFlowService(new RollbackingTransactionRunner());
