...
import static team.carrypigeon.backend.chat.domain.features.channel.application.service.ChannelApplicationServiceTestSupport.systemChannel;
 ...
 */
@Tag("contract")
class ChannelApplicationServiceAccessTests {
    ...
    void getDefaultChannel_existingChannel_returnsResult() {
        ...
        ChannelAccessApplicationService service = context.createAccessService();
