 ...
 */
@Tag("contract")
class ChannelApplicationServiceLifecycleTests {
    ...
    void createPrivateChannel_validCommand_savesPrivateChannelAndOwnerMembership() {
        ...
        ChannelLifecycleApplicationService service = context.createLifecycleService();
    ...
    void createPrivateChannel_rollback_skipsRealtimePublish() {
        TestContext context = newContext();
        ChannelLifecycleApplicationService service = context.createLifecycleService(new RollbackingTransactionRunner());
