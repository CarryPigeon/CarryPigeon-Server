 ...
 */
@Service
public class MessagePluginCatalogDomainApi implements MessagePluginCatalogApi {

    private final ChannelMessagePluginRegistry channelMessagePluginRegistry;

    public MessagePluginCatalogDomainApi(ChannelMessagePluginRegistry channelMessagePluginRegistry) {
