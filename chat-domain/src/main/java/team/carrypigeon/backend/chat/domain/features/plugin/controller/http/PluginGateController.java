...
import team.carrypigeon.backend.chat.domain.features.plugin.domain.projection.RequiredGateCheckResult;
import team.carrypigeon.backend.chat.domain.features.plugin.controller.dto.RequiredGateCheckRequest;
...
public class PluginGateController {
     ...
     */
    public PluginGateController(PluginCatalogApi pluginCatalogApi) {
    ...
    public RequiredGateCheckResult check(@Valid @RequestBody RequiredGateCheckRequest request) {
        List<String> missingPlugins = pluginCatalogApi.findMissingRequiredPlugins(
