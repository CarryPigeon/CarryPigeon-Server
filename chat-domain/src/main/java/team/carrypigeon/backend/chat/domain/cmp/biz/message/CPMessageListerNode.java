...
public class CPMessageListerNode extends CPNodeComponent {
    ...
    public void process(CPSession session, CPFlowContext context) throws Exception {
        ...
        Integer count = requireContext(context, CPNodeMessageKeys.MESSAGE_LIST_COUNT, Integer.class);
        ...
        CPMessage[] messages = select(context,
                buildSelectKey("message_list", java.util.Map.of("cid", cid, "count", count, "startTime", finalStartTime)),
                () -> channelMessageDao.getBefore(cid, start, count));
        if (messages == null) {
