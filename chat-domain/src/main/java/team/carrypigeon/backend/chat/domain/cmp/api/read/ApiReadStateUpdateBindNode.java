...
/**
 * Bind read state update request into existing LiteFlow context keys.
 * <p>
 * Route: {@code PUT /api/channels/{cid}/read_state}
 * <p>
 * Input: {@link ApiFlowKeys#REQUEST} = {@link ReadStateUpdateRequest}
 * Output:
 * <ul>
 *   <li>{@link CPNodeChannelReadStateKeys#CHANNEL_READ_STATE_INFO_CID}: channel id</li>
 *   <li>{@link CPNodeChannelReadStateKeys#CHANNEL_READ_STATE_INFO_LAST_READ_MID}: last read message id</li>
 *   <li>{@link CPNodeChannelReadStateKeys#CHANNEL_READ_STATE_INFO_LAST_READ_TIME}: last read time (millis)</li>
 * </ul>
 */
@Slf4j
@AllArgsConstructor
