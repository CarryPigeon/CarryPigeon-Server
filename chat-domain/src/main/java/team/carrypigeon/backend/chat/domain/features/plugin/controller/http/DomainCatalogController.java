...
import team.carrypigeon.backend.chat.domain.features.plugin.controller.dto.DomainCatalogItemResponse;
import team.carrypigeon.backend.chat.domain.features.plugin.controller.dto.DomainCatalogResponse;
import team.carrypigeon.backend.chat.domain.features.plugin.controller.dto.DomainConstraintsResponse;
import team.carrypigeon.backend.chat.domain.features.plugin.controller.dto.DomainProviderResponse;
...
public class DomainCatalogController {
    ...
    public DomainCatalogResponse getDomainCatalog() {
        return new DomainCatalogResponse(pluginCatalogApi.listPublicPlugins().stream()
    ...
    private DomainProviderResponse provider(PluginCatalogItemResult plugin) {
