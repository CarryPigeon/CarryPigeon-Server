package team.carrypigeon.backend.dao.mapper.file;
...
public class FilePO {
    ...
    public void fill(CPFileBO fileBO){
        ...
        this.time = TimeUtil.toLocalDateTime(fileBO.getTime());
    }

    public CPFileBO toBO(){
        return new CPFileBO(this.id, this.name, this.sha256, this.size, TimeUtil.toMillis(this.time));
    }
}
